...
class SQLParser : public antlr4::Parser {
 public:
  ...
  enum {
    ...
    RuleStatement = 1,
    RuleDb_statement = 2,
    RuleTable_statement = 3,
    RuleSelect_table = 4,
    RuleIndex_statement = 5,
    RuleField_list = 6,
    RuleField = 7,
    RuleType_ = 8,
    RuleValue_lists = 9,
  ...
  class Db_statementContext : public antlr4::ParserRuleContext {
   public:
    Db_statementContext(antlr4::ParserRuleContext *parent,
  ...
  class Table_statementContext : public antlr4::ParserRuleContext {
   public:
    Table_statementContext(antlr4::ParserRuleContext *parent,
                           size_t invokingState);
  ...
  class Select_tableContext : public antlr4::ParserRuleContext {
   public:
    Select_tableContext(antlr4::ParserRuleContext *parent,
                        size_t invokingState);
    virtual size_t getRuleIndex() const override;
  ...
  class Index_statementContext : public antlr4::ParserRuleContext {
   public:
    Index_statementContext(antlr4::ParserRuleContext *parent,
                           size_t invokingState);
  ...
  class Create_indexContext : public Index_statementContext {
   public:
    Create_indexContext(Index_statementContext *ctx);
  ...
  class Drop_indexContext : public Index_statementContext {
   public:
    Drop_indexContext(Index_statementContext *ctx);
  ...
  class Where_and_clauseContext : public antlr4::ParserRuleContext {
   public:
    Where_and_clauseContext(antlr4::ParserRuleContext *parent,
                            size_t invokingState);
    virtual size_t getRuleIndex() const override;
  ...
  class Where_clauseContext : public antlr4::ParserRuleContext {
   public:
    Where_clauseContext(antlr4::ParserRuleContext *parent,
                        size_t invokingState);
